...
obj_background_tile.scroll_speed -= 0.005;
audio_sound_gain(city, audio_sound_get_gain(city) - 0.0005)
audio_sound_gain(tram, audio_sound_get_gain(tram) - 0.0005)
audio_sound_gain(birdsong, audio_sound_get_gain(birdsong) + 0.00005)
//obj_sky.image_alpha += 0.0001;
obj_sky.image_alpha += 0.0001;
...
//or mouse_check_button_pressed(mb_left)
{
	...
	// this code removes stims at the end
