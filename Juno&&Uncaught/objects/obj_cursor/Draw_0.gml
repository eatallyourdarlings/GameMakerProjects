...
//draw_text(x + 10, y + 10, $"delta: {mouse_delta_x},{mouse_delta_y}");
...
draw_sprite_ext(spr_conch, image_index, x, y, image_xscale, image_yscale, image_angle, image_blend,image_alpha);
